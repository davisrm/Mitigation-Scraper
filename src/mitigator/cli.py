from mitigator.config import GOOGLE_KEY, DB_PATH, CSV_OUT, KEYWORDS, SERVICE_AREAS
from mitigator.collect import google_text_search, yelp_search
...
def main():
    ...
    for loc in SERVICE_AREAS:
        for kw in KEYWORDS:
            ...
            # for r in yelp_search(YELP_KEY, kw, loc):
            #     save_company(DB_PATH, r); all_rows.append(r)
